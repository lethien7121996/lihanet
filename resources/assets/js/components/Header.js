...
class Header extends Component {
  ...
  handleLogout(e)
  {
    ...
    window.location.href = 'http://103.57.222.116/Demo/lihanet';
  }
  render () {
    ...
    return (
      ...
      <div className="navbar-header"> <a className="navbar-toggle hidden-sm hidden-md hidden-lg " href="#" onClick={e => e.preventDefault()} data-toggle="collapse" data-target=".navbar-collapse"><i className="ti-menu" /></a>
        <div className="top-left-part"><Link className="logo" to="/"><b><img id="logomain" src="./public/app_assets/plugins/images/quochuy.png" alt="home" width="200px" /></b></Link></div>
